...
[![Power BI](https://img.shields.io/badge/Power%20BI-Saarth%20Shetty-gold?style=flat)](https://app.powerbi.com/links/x_BEXo8_4A?ctid=a2e8c89e-7534-4ccf-b1fa-00c12005cb9d&pbi_source=linkShare&bookmarkGuid=ef4fde42-5ed7-4a3a-b773-200d74946dec)

---

## Key Features

- **Unlocking Insights for Informed Healthcare Decision-Making:** This endeavor offers a comprehensive analysis of the U.S. healthcare industry for the years 2019-2020 through Power BI. Dive into detailed reports and visualizations that provide strategic insights for healthcare stakeholders.
...
For a detailed report and interactive analysis, refer to the [U.S. Healthcare Dynamics Insights Report](docs/project_synopsis.docx).
...
1. **Clone the Repository:**
   ```bash
   git clone https://github.com/saarthshetty/US-Healthcare-Analytics-PowerBI-Insights.git
   ```
...
Find issues, suggest enhancements, or contribute to the project by opening an issue or submitting a pull request through the repository's GitHub interface.
...
This Power BI-driven initiative is maintained by Saarth Shetty and is licensed under the MIT License, focusing on providing comprehensive insights into the U.S. healthcare industry from 2019 to 2020. The meticulously designed reports and visualizations offer strategic intelligence for stakeholders in the healthcare landscape.
...
- **Enhanced Decision-Making:**
  - The interactive Power BI dashboard facilitates informed decision-making by offering detailed and dynamic visualizations of key healthcare metrics.
...
**Saarth Shetty** is a Business Analyst with over 3 years of experience translating complex operational and financial data into decision-ready narratives for executive and cross-functional stakeholders. Skilled in Power BI, SQL, Python, and SAP (ERP) environments, Saarth specializes in designing KPI frameworks and multi-source dashboards that connect performance trends to operational decisions.

### Connect With Me

- **LinkedIn:** [linkedin.com/in/saarth-shetty](http://www.linkedin.com/in/saarth-shetty)
- **Email:** saarthshetty98@gmail.com
- **GitHub:** [github.com/saarthshetty](https://github.com/saarthshetty)